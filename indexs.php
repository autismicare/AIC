...
<body>
<!-- Top Nav bar -->
<?php include 'navBar_login.php'; ?><br>
<!-- Top Nav bar -->
...
<!-- Start Carousel -->
  <div id="carousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner mt-5">
      <a class="carousel-item active" href="facts.php">
...
<h3>Diary</h3>
  <p class="text-left">Track your child's mood and behaviour, without typing long lines of text. Look through the list of emojis and icons, and pick the ones that apply</p>
      ...
      <h4>Facts about Autism</h4>
        <div>
          <?php                       
            ...
            ?>
            <a href='facts.php' class='btn btn-secondary' role='button'>More Facts</a><br><br>
        </div>
  </div><br>
...
<!--   Start call two events -->
    ...
    <br><a href="events.php" class="btn btn-secondary text-center" role="button">More Events</a>
      </div></div>
    </div><br> 
<!--     End call two events -->

...
<?php 
$get = "SELECT distinct(date(Tracking_date)) as TrackingDate from MBTracker where User_ID = '$uid' and Tracking_date > DATE_ADD((select max(Tracking_date) from MBTracker where User_ID = '$uid'), INTERVAL -7 DAY) order by TrackingDate";
...
<head>
    ...
    <script type="text/javascript" src="js/weekly_chart.js"></script>
	<script type="text/javascript" src="js/mood_weekly_doughnut_chart.js"></script>
    <script type="text/javascript" src="js/behaviour_weekly_doughnut_chart.js"></script>
    <script type="text/javascript" src="js/factor_weekly_doughnut_chart.js"></script>
    <script>
...
<!-- Start Table menu -->    
    <div class="d-flex justify-content-center">
    <form method="post" action="weekly_show_chart.php">

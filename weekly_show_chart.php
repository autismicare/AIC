<?php 
include('as.php');
include('weekly_mbf_chart.php');
include('weekly_rating_chart.php');
...
<!-- Start Table menu -->    
  <div class="container text-center d-flex justify-content-center mt-4" style="background-color:transparent;box-shadow:none;">
    <form method="post" action="weekly_show_chart.php">
      <select class="form-control mb-2" name="TD" id="TD" onchange="myFunction(this)">
...
<!-- Start Data Table -->    
    <div class="container shadow p-3 mt-2" style="overflow-x:auto;">
